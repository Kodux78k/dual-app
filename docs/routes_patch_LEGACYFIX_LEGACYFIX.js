...
export function initSplashRoute(opts = {}){
  ...
  function renderSplashIframe(){
    (function(__el,__val){try{if(window.DualRender){if(typeof __val==='string' && (/[╔╦╚╝═│┌┐└┘█▄▀◉`]/.test(__val))){return DualRender.renderASCII(__el,__val);}else{return (DualRender.renderSmart?DualRender.renderSmart(__el,__val):((function(__el,__val){try{if(window.DualRender){if(typeof __val==='string' && (/[╔╦╚╝═│┌┐└┘█▄▀◉`]/.test(__val))){return DualRender.renderASCII(__el,__val);}else{return (DualRender.renderSmart?DualRender.renderSmart(__el,__val):(__el.innerHTML=__val));}}}catch(__e){}__el.innerHTML=__val;})(__el, __val)));}}}catch(__e){}(function(__el,__val){try{if(window.DualRender){if(typeof __val==='string' && (/[╔╦╚╝═│┌┐└┘█▄▀◉`]/.test(__val))){return DualRender.renderASCII(__el,__val);}else{return (DualRender.renderSmart?DualRender.renderSmart(__el,__val):(__el.innerHTML=__val));}}}catch(__e){}__el.innerHTML=__val;})(__el, __val);})(mount, `
  ...
  if (cfg.asModal){
    window.DualSplash = {
      open(){
        ...
        (function(__el,__val){try{if(window.DualRender){if(typeof __val==='string' && (/[╔╦╚╝═│┌┐└┘█▄▀◉`]/.test(__val))){return DualRender.renderASCII(__el,__val);}else{return (DualRender.renderSmart?DualRender.renderSmart(__el,__val):((function(__el,__val){try{if(window.DualRender){if(typeof __val==='string' && (/[╔╦╚╝═│┌┐└┘█▄▀◉`]/.test(__val))){return DualRender.renderASCII(__el,__val);}else{return (DualRender.renderSmart?DualRender.renderSmart(__el,__val):(__el.innerHTML=__val));}}}catch(__e){}__el.innerHTML=__val;})(__el, __val)));}}}catch(__e){}(function(__el,__val){try{if(window.DualRender){if(typeof __val==='string' && (/[╔╦╚╝═│┌┐└┘█▄▀◉`]/.test(__val))){return DualRender.renderASCII(__el,__val);}else{return (DualRender.renderSmart?DualRender.renderSmart(__el,__val):(__el.innerHTML=__val));}}}catch(__e){}__el.innerHTML=__val;})(__el, __val);})(modal, `
